...
// era. O único chamador que se beneficia de `exigirDonoOuMcp()` é a ferramenta
// `anexar_contexto`. E `deletarContexto` ficou em `exigirSessaoDoDono()`: o
// MCP não tem ferramenta de apagar, e não é para ganhar uma sem alguém decidir
// isso de propósito.
